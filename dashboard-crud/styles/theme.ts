...
export const lightTheme: DefaultTheme = {
  color: {
    ...
    mainContentItemInputBorder: color.argent,
    mainContentItemLoginButtonBackground: color.ultramarineBlue,
    mainContentItemLoginButtonText: color.white,
  },
};
...
export const darkTheme: DefaultTheme = {
  color: {
    ...
    mainContentItemInputBorder: color.arsenic,
    mainContentItemLoginButtonBackground: color.ultramarineBlue,
    mainContentItemLoginButtonText: color.white,
  },
};
